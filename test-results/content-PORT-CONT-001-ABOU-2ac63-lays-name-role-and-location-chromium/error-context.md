...
- Name: content.spec.ts >> PORT-CONT-001 | ABOUT section displays name, role, and location
- Location: tests/content.spec.ts:6:5
...
Expected pattern: /Canada|Vancouver|Waterloo/i
Received string:  "You need to enable JavaScript to run this app.18:34
              div::-webkit-scrollbar {
                display: none;
              }
            JungWon JUNGiOS Developer · Backend Engineer3 Apps on the App StoreABOUTNameJungWon JUNGRoleiOS DeveloperLocationKatowice, PolandSpent a few years as a backend developer in Seoul — building APIs, optimizing queries, learning how real products work under the hood. At some point I wanted to build the parts users actually touch. Moved to Poland, picked up Swift, and shipped 3 apps to the App Store — including PARKinPL, built specifically for navigating parking in Polish cities.iOS DEVELOPMENTSwiftSwiftUIUIKitCombineCoreLocationMapKitFirebaseMVVMBACKEND & WEBNestJSTypeScriptMySQL · MongoDBElasticsearchREST APIsPROJECTSPARKinPLApp StoreChallengersApp StoreDev60sApp StoreCAREERTelus Digital2024Avelinix2024FlareLane2021Shipda2021EDUCATIONWSB UniversityMajorComputer ScienceDegreeB.Sc.ExpectedWinter 2026CONTACTLinkedInGitHubEmailwjdwjd1501@gmail.comResume"
```
